...
htmlhelp_basename = "TileDBSOMA-Pydoc"
...
latex_documents = [
    (master_doc, "TileDBSOMA-Py.tex", "TileDBSOMA-Py Documentation", "TileDB, Inc.", "manual")
]
...
man_pages = [(master_doc, "tiledbsoma-py", "TileDBSOMA-Py Documentation", [author], 1)]
