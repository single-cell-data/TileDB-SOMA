...
- \[[#4250](https://github.com/single-cell-data/TileDB-SOMA/pull/4250) X optional for tiledbsoma.ExperimentAxisQuery.to_anndata() in parity with tiledbsoma.io.to_anndata() \]
