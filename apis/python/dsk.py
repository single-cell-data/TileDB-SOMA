...
from click import argument, group, option, Context, Parameter, BadParameter
...
from tiledbsoma._dask import make_context, DaskConfig
            ...
            if memray_bin_path is None:
                ...
                if h5ad_path:
                    if tdb_concurrency is not None:
                        raise ValueError(f"Received -T/--tdb-concurrency and -H/--h5ad-path")
                else:
