...
@pytest.mark.carrara
def test_collection_delete_member_by_name(group_path: str, carrara_context: soma.SOMATileDBContext) -> None:
    """
...
@pytest.mark.carrara
def test_collection_delete_member_object(group_path: str, carrara_context: soma.SOMATileDBContext) -> None:
    """
