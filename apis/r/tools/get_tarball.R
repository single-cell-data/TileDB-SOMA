...
if (isMac) {
  ...
  if (arch == "x86_64") {
    url <- "https://github.com/TileDB-Inc/TileDB/releases/download/2.29.0-rc1/tiledb-macos-x86_64-2.29.0-rc1-b5a7e8d.tar.gz"
  } else if (arch == "arm64") {
    url <- "https://github.com/TileDB-Inc/TileDB/releases/download/2.29.0-rc1/tiledb-macos-arm64-2.29.0-rc1-b5a7e8d.tar.gz"
  } else {
    stop(
  ...
  url <- "https://github.com/TileDB-Inc/TileDB/releases/download/2.29.0-rc1/tiledb-linux-x86_64-2.29.0-rc1-b5a7e8d.tar.gz"
} else {
  message(
...
if (!dir.exists("inst/tiledb")) {
  untar(tarball, exdir = "inst/tiledb")
}
