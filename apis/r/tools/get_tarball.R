...
if (isMac) {
  ...
  if (arch == "x86_64") {
    url <- "https://github.com/TileDB-Inc/TileDB/releases/download/2.29.0/tiledb-macos-x86_64-2.29.0-958e736.tar.gz"
  } else if (arch == "arm64") {
    url <- "https://github.com/TileDB-Inc/TileDB/releases/download/2.29.0/tiledb-macos-arm64-2.29.0-958e736.tar.gz"
  } else {
    stop(
  ...
  url <- "https://github.com/TileDB-Inc/TileDB/releases/download/2.29.0/tiledb-linux-x86_64-2.29.0-958e736.tar.gz"
} else {
  message(
