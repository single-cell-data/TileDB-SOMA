...
SOMACollectionBase <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description Create a SOMA collection (lifecycle: maturing)
    #'
    #' @return \code{self}
    #'
    ...
    #' object's URI is assumed to be relative unless it is a
    #' \dQuote{\code{tiledb://}} URI.
    #'
    ...
    #'
    #' @return The SOMA object in \code{self} specified by \code{name}
    #'
    get = function(name) {
      # browser()
    ...
    #'
    #' @return The new SOMA data frame
