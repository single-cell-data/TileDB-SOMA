...
While *tiledbsoma* is currently focused on facilitating the storage and retrieval of complete Seurat/Bioconductor datasets, it is possible to selectively update specific components of an existing `SCGroup`.
