...
matrix format is `dgTMatrix` as it is the most memory-efficient and the only
format type that can be easily iterated. And most importantly, the resulting
object is a "view" of the full matrix with the original shape and indexes but only
with data corresponding to the query coordinates or filters (see section below).
