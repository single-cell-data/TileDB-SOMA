...
#X <- expold.ms$get("RNA")$X$get("data")
```
...
#    exp$ms$get("RNA")$X$get("data").tiledbsoma_upgrade_shape([X.non_empty_domain()[0][1]+1, X.non_empty_domain()[1][1]+1])
```
...
#    exp$ms$get("RNA")$X$get("data").resize([7200, 1848])
#expold <- tiledbsoma.Experiment.open(expold.uri)
#X <- expold.ms$get("RNA")$X$get("data")
#X$shape
#(7200, 1848)
...
* Otherwise invoke `$change_domain()`
