...
const tiledb_xptr_object tiledb_xptr_somaobj_wrapper_t{210};
...
template <>
inline const int32_t XPtrTagType<tiledb::ArraySchema> = tiledb_xptr_object_arrayschema;
template <>
inline const int32_t XPtrTagType<tiledb::ArraySchemaEvolution> = tiledb_xptr_object_arrayschemaevolution;
template <>
inline const int32_t XPtrTagType<tiledb::Attribute> = tiledb_xptr_object_attribute;
template <>
...
template <>
inline const int32_t XPtrTagType<tiledb::Dimension> = tiledb_xptr_object_dimension;
template <>
...
template <>
inline const int32_t XPtrTagType<tiledb::FilterList> = tiledb_xptr_object_filterlist;
template <>
inline const int32_t XPtrTagType<tiledb::FragmentInfo> = tiledb_xptr_object_fragmentinfo;
template <>
...
template <>
inline const int32_t XPtrTagType<tiledb::QueryCondition> = tiledb_xptr_object_query;
template <>
...
template <>
inline const int32_t XPtrTagType<tdbs::IntIndexer> = tiledb_soma_rindexer_t;

template <>
inline const int32_t XPtrTagType<somactx_wrap_t> = tiledb_xptr_somactx_wrapper_t;
template <>
inline const int32_t XPtrTagType<somaobj_wrap_t> = tiledb_xptr_somaobj_wrapper_t;
