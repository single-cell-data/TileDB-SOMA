...
* Within `apis/r`, if you've edited any `src/*.cpp` with `RcppExport` then run `Rcpp::compileAttributes()`
...
* If you've changed any signatures, from within `apis/r` run `roxygen2::roxygenise()`
