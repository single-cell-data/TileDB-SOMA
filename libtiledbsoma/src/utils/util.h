 ...
 */
bool TILEDBSOMA_EXPORT is_tiledb_uri(std::string_view uri);
 ...
 */
std::string TILEDBSOMA_EXPORT rstrip_uri(std::string_view uri);
 ...
 */
std::optional<std::vector<uint8_t>> TILEDBSOMA_EXPORT
bitmap_to_uint8(const uint8_t* bitmap, size_t length, size_t offset = 0);

std::shared_ptr<SOMAColumn> TILEDBSOMA_EXPORT find_column_by_name(
 ...
 */
std::string TILEDBSOMA_EXPORT
get_enmr_label(ArrowSchema* index_schema, ArrowSchema* value_schema);
 ...
 */
Enumeration TILEDBSOMA_EXPORT get_enumeration(
 ...
 */
std::string TILEDBSOMA_EXPORT
soma_type_from_tiledb_type(tiledb::Object::Type tiledb_type);
