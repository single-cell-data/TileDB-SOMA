...
class DimensionConfigAdapter {
    ...
    */
    ...
    Dimension create_dimension(const Context& ctx, std::string name) const {
        return Dimension::create(ctx, name, max_domain_, tile_extent_);
    }

    Dimension create_dimension(const Context& ctx, std::string name, tiledb_datatype_t datatype) const {
        return Dimension::create(ctx, name, datatype, max_domain_.data(), &tile_extent_);
    }
