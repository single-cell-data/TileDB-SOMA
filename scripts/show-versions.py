...
def main():
    # The pre-commit-hook linter insists on moving import tiledb before import
    # tiledbsoma but we want it after
    # https://github.com/single-cell-data/TileDB-SOMA/issues/2293
    import tiledb
