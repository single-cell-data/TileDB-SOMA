...
Default schema-level TileDB parameters are set to be useful for most
users.

If you have particular needs or use-cases, though, you can use the
`PlatformConfig` options to override default schema parameters.
...
This can then be passed to `SOMADataFrameCreate`,
`SOMASparseNDArrayCreate`, et al.
