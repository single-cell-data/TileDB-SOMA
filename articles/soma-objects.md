...
uri
#> [1] "/tmp/Rtmp4oQBRt/soma-exp-pbmc-small"
```
...
experiment
#> <SOMAExperiment>
#>   uri: /tmp/Rtmp4oQBRt/soma-exp-pbmc-small
```
...
experiment$ms
#> <SOMACollection>
#>   uri: file:///tmp/Rtmp4oQBRt/soma-exp-pbmc-small/ms
```
...
experiment$obs
#> <SOMADataFrame>
#>   uri: file:///tmp/Rtmp4oQBRt/soma-exp-pbmc-small/obs
...
#> <SOMAMeasurement>
#>   uri: file:///tmp/Rtmp4oQBRt/soma-exp-pbmc-small/ms/RNA
```
...
X
#> <SOMACollection>
#>   uri: file:///tmp/Rtmp4oQBRt/soma-exp-pbmc-small/ms/RNA/X
```
...
X_data
#> <SOMASparseNDArray>
#>   uri: file:///tmp/Rtmp4oQBRt/soma-exp-pbmc-small/ms/RNA/X/data
