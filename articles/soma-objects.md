...
uri
#> [1] "/tmp/RtmplnoCF3/soma-exp-pbmc-small"
```
...
experiment
#> <SOMAExperiment>
#>   uri: /tmp/RtmplnoCF3/soma-exp-pbmc-small
```
...
experiment$ms
#> <SOMACollection>
#>   uri: file:///tmp/RtmplnoCF3/soma-exp-pbmc-small/ms
```
...
experiment$obs
#> <SOMADataFrame>
#>   uri: file:///tmp/RtmplnoCF3/soma-exp-pbmc-small/obs
...
#> <SOMAMeasurement>
#>   uri: file:///tmp/RtmplnoCF3/soma-exp-pbmc-small/ms/RNA
```
...
X
#> <SOMACollection>
#>   uri: file:///tmp/RtmplnoCF3/soma-exp-pbmc-small/ms/RNA/X
```
...
X_data
#> <SOMASparseNDArray>
#>   uri: file:///tmp/RtmplnoCF3/soma-exp-pbmc-small/ms/RNA/X/data
